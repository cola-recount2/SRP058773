...
|:---------------------------|----------:|-----:|---------------:|-----------:|:--|:----------|
|[SD:pam](#SD-pam)           |          2| 1.000|           0.968|       0.985|** |           |
|[MAD:hclust](#MAD-hclust)   |          2| 1.000|           0.979|       0.989|** |           |
|[MAD:kmeans](#MAD-kmeans)   |          2| 1.000|           0.991|       0.995|** |           |
|[MAD:pam](#MAD-pam)         |          2| 1.000|           0.992|       0.996|** |           |
|[ATC:kmeans](#ATC-kmeans)   |          2| 1.000|           0.964|       0.986|** |           |
|[ATC:hclust](#ATC-hclust)   |          2| 0.959|           0.965|       0.984|** |           |
|[ATC:skmeans](#ATC-skmeans) |          2| 0.959|           0.942|       0.976|** |           |
|[CV:skmeans](#CV-skmeans)   |          2| 0.957|           0.955|       0.980|** |           |
|[MAD:skmeans](#MAD-skmeans) |          3| 0.928|           0.928|       0.961|*  |2          |
|[SD:kmeans](#SD-kmeans)     |          2| 0.919|           0.949|       0.979|*  |           |
|[CV:kmeans](#CV-kmeans)     |          2| 0.919|           0.937|       0.972|*  |           |
|[ATC:pam](#ATC-pam)         |          3| 0.904|           0.882|       0.946|*  |2          |
|[SD:skmeans](#SD-skmeans)   |          2| 0.880|           0.897|       0.959|   |           |
|[CV:mclust](#CV-mclust)     |          2| 0.880|           0.919|       0.965|   |           |
|[SD:hclust](#SD-hclust)     |          2| 0.839|           0.913|       0.960|   |           |
|[CV:pam](#CV-pam)           |          2| 0.710|           0.894|       0.940|   |           |
|[ATC:NMF](#ATC-NMF)         |          3| 0.681|           0.795|       0.896|   |           |
|[MAD:NMF](#MAD-NMF)         |          2| 0.654|           0.831|       0.913|   |           |
|[ATC:mclust](#ATC-mclust)   |          2| 0.571|           0.840|       0.898|   |           |
|[CV:NMF](#CV-NMF)           |          2| 0.559|           0.764|       0.901|   |           |
|[SD:mclust](#SD-mclust)     |          4| 0.543|           0.656|       0.781|   |           |
|[MAD:mclust](#MAD-mclust)   |          3| 0.476|           0.787|       0.856|   |           |
|[CV:hclust](#CV-hclust)     |          2| 0.295|           0.732|       0.849|   |           |
|[SD:NMF](#SD-NMF)           |          2| 0.149|           0.759|       0.814|   |           |
...
<ul>
<li><a href='#tab-top-rows-overlap-by-euler-1'>top_n = 435</a></li>
<li><a href='#tab-top-rows-overlap-by-euler-2'>top_n = 870</a></li>
<li><a href='#tab-top-rows-overlap-by-euler-3'>top_n = 1306</a></li>
<li><a href='#tab-top-rows-overlap-by-euler-4'>top_n = 1741</a></li>
<li><a href='#tab-top-rows-overlap-by-euler-5'>top_n = 2176</a></li>
</ul>
<div id='tab-top-rows-overlap-by-euler-1'>
<pre><code class="r">top_rows_overlap(res_list, top_n = 435, method = &quot;euler&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 870, method = &quot;euler&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 1306, method = &quot;euler&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 1741, method = &quot;euler&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 2176, method = &quot;euler&quot;)
</code></pre>
...
<ul>
<li><a href='#tab-top-rows-overlap-by-correspondance-1'>top_n = 435</a></li>
<li><a href='#tab-top-rows-overlap-by-correspondance-2'>top_n = 870</a></li>
<li><a href='#tab-top-rows-overlap-by-correspondance-3'>top_n = 1306</a></li>
<li><a href='#tab-top-rows-overlap-by-correspondance-4'>top_n = 1741</a></li>
<li><a href='#tab-top-rows-overlap-by-correspondance-5'>top_n = 2176</a></li>
</ul>
<div id='tab-top-rows-overlap-by-correspondance-1'>
<pre><code class="r">top_rows_overlap(res_list, top_n = 435, method = &quot;correspondance&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 870, method = &quot;correspondance&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 1306, method = &quot;correspondance&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 1741, method = &quot;correspondance&quot;)
</code></pre>
...
<pre><code class="r">top_rows_overlap(res_list, top_n = 2176, method = &quot;correspondance&quot;)
</code></pre>
...
<ul>
<li><a href='#tab-top-rows-heatmap-1'>top_n = 435</a></li>
<li><a href='#tab-top-rows-heatmap-2'>top_n = 870</a></li>
<li><a href='#tab-top-rows-heatmap-3'>top_n = 1306</a></li>
<li><a href='#tab-top-rows-heatmap-4'>top_n = 1741</a></li>
<li><a href='#tab-top-rows-heatmap-5'>top_n = 2176</a></li>
</ul>
<div id='tab-top-rows-heatmap-1'>
<pre><code class="r">top_rows_heatmap(res_list, top_n = 435)
</code></pre>
...
<pre><code class="r">top_rows_heatmap(res_list, top_n = 870)
</code></pre>
...
<pre><code class="r">top_rows_heatmap(res_list, top_n = 1306)
</code></pre>
...
<pre><code class="r">top_rows_heatmap(res_list, top_n = 1741)
</code></pre>
...
<pre><code class="r">top_rows_heatmap(res_list, top_n = 2176)
</code></pre>
